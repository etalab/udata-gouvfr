...
I18N_ROOT = 'udata_front/translations'
...
def i18n(ctx, update=False):
    ...
    with ctx.cd(ROOT):
        ...
        set_po_metadata(os.path.join(I18N_ROOT, 'udata-front.pot'), 'en')
        for lang in LANGUAGES:
            pofile = os.path.join(I18N_ROOT, lang, 'LC_MESSAGES', 'udata-front.po')
